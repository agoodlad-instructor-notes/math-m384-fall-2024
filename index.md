...
My lecture notes for this class are divided by chapters on the book we use, which was the 2nd edition of *A Mathematical Introduction to Logic by Herbert B. Enderton*.

Here are my lecture notes for this class:

%UPLOAD THE NOTES AND LINK THEM HERE
%POSSIBLY MENTION OPTIONAL COURSE NOTES AND DEVIATIONS FROM THE BOOK
%MENTION OMISSIONS OF THE NOTES AS WELL
